...
class _PlaylistScreenState extends State<PlaylistScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(126, 41, 227, 147),
        elevation: 0,
        leadingWidth: 140.0,
        leading: Padding(
            ...
            children: [
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    color: Color.fromARGB(188, 184, 227, 53),
              ...
              InkWell(
                ...
                child: Container(
                  padding: const EdgeInsets.all(6.0),
                  decoration: const BoxDecoration(
                    color: Color.fromARGB(131, 116, 10, 196),
                    shape: BoxShape.circle,
                  ),
        ...
        actions: [
          TextButton.icon(
            ...
            label: const Text('Utkarsh & Aayush'),
          ),
